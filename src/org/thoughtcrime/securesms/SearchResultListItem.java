...
public class SearchResultListItem extends RelativeLayout
                                  implements Recipients.RecipientsModifiedListener,
                                             BindableSearchResultListItem, Unbindable
{
  private final static String TAG = SearchResultListItem.class.getSimpleName();
  ...
  public void bind(@NonNull MasterSecret masterSecret, @NonNull MasterCipher masterCipher, @NonNull MessageRecord message,
                   @NonNull Locale locale, @NonNull Set<Long> selectedThreads, boolean batchMode)
  {
    ThreadRecord thread = DatabaseFactory.getThreadDatabase(getContext()).getConversationById(message.getThreadId(), masterCipher);
    ...
    this.subjectView.setText(message.getDisplayBody());
  ...
  private void setThumbnailSnippet(MasterSecret masterSecret, ThreadRecord thread) {
    if (thread.getSnippetUri() != null) {
      ...
      LayoutParams subjectParams = (LayoutParams)this.subjectView.getLayoutParams();
  ...
  private static class ThumbnailPositioner implements Runnable {
    ...
    @Override
    public void run() {
      LayoutParams thumbnailParams = (LayoutParams)thumbnailView.getLayoutParams();
