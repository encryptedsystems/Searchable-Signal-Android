...
public class MasterSecretUtil {
                                                          ...
                                                          String newPassphrase)
  {
    try {
      ...
      if (masterSecret.getEdbSecret() == null) {
        // shoudl have been generated by getMasterSecret() for backward compatibility or at initiation time
        throw new EdbException("No edb secret when changing passphrase");
      }
      saveEdbSecret(context, newPassphrase, encryptionSalt, iterations, macSalt, masterSecret.getEdbSecret());
  ...
  private static EdbSecret generateEdbSecret(Context context, String passphrase, byte[] encryptionSalt, int iterations, byte[] macSalt) throws GeneralSecurityException {
    ...
    saveEdbSecret(context, passphrase, encryptionSalt, iterations, macSalt, edbSecret);
    return edbSecret;
  }
